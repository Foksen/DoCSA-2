...
public class SecurityConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient shopClient = RegisteredClient.withId(UUID.randomUUID().toString())
            ...
            .redirectUri("http://localhost:8081/login/oauth2/code/shop-client")
            .redirectUri("http://localhost:8082/login/oauth2/code/shop-client")
            .redirectUri("http://localhost:8083/login/oauth2/code/shop-client")
